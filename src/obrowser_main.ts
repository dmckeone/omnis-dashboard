...
const elem = document.getElementById("omnis-dashboard")
mountApp(OBROWSER_ID, elem)

// Fetch the control hooks for data to Omnis
const hooks = window.ctrl_omnis_dashboard_hooks.get(OBROWSER_ID)
...
window.ctrl_omnis_dashboard_hooks.set(OBROWSER_ID, hooks)
